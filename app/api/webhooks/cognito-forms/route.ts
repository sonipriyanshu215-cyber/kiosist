...
// .env.local.example. Cognito Forms emails the recipients configured in
// its own dashboard (this app does NOT send the application email)- this
// route's only job is mirroring the submission into this app's own
// Admin -> Inquiries.
//
