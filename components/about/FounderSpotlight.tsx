...
export function FounderSpotlight() {
  ...
  return (
    <section className="bg-kio-primary relative overflow-hidden">
      {/* Transparent gradient wash- fades accent colours into the dark
          section background rather than a flat tint. */}
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0"
        style={{
          background:
            "radial-gradient(ellipse 65% 55% at 78% 45%, rgba(59,130,246,0.16), transparent 70%), radial-gradient(ellipse 45% 40% at 10% 85%, rgba(6,182,212,0.10), transparent 70%)",
        }}
      />
      ...
      <div className="container-kio relative z-10 flex flex-col items-center gap-10 py-16 text-center md:py-20 lg:flex-row lg:justify-center lg:gap-0 lg:py-24 lg:text-left">
        ...
        <div className="relative z-10 lg:-mr-10">
          ...
          <RevealOnScroll delay={0.1}>
            ...
            <div className="mx-auto mt-6 h-px max-w-md bg-white/15 lg:mx-0" />
          </RevealOnScroll>
        ...
        <motion.div
          ...
          className="relative h-[420px] w-[280px] shrink-0 sm:h-[480px] sm:w-[320px] lg:-ml-12 lg:h-[600px] lg:w-[380px]"
        >
