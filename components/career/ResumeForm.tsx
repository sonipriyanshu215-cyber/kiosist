...
// /api/careers)- replaced with an embedded Cognito Forms widget, which now
// owns the fields, validation, resume upload and applicant notifications on
// its own platform. Only the surrounding heading/section chrome stayed.
// (Cognito's own dashboard configures who gets the notification email; this
// app's /api/webhooks/cognito-forms mirrors each submission into Admin ->
// Inquiries.)
